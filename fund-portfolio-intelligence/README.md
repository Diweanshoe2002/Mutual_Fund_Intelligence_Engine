...
2. **Caching**: Neo4j query results are cached when appropriate
3. **Connection Pooling**: Database connections are pooled
4. **Rate Limiting**: LLM API calls are rate-limited
...
- Human approval required for data modification queries
...
Armstrong Capital - Financial Intelligence Systems
...
- DSPy for structured LLM operations

## 📞 Support

For issues and questions:
- Create an issue on GitHub
- Email: support@armstrongcapital.com
